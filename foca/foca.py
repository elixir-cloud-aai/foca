...
def foca(config: Optional[str] = None) -> App:
    ...
    Args:
        config (Optional[str], optional): Path to a YAML application
            configuration file. For required YAML file structure, see
            :py:class:`foca.models.config.Config()`. Defaults to None.
