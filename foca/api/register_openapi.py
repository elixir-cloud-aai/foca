...
def register_openapi(
    ...
    Returns:
        A `Connexion <https://connexion.readthedocs.io/en/latest/index.html>`_
        app instance.

    Raises:
        :py:exc:`OSError`: File cannot be read from or written to.
        :py:exc:`yaml.YAMLError`: YAML cannot be (de)serialized.
    """
